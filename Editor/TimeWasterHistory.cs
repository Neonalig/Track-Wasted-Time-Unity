...
namespace GameDevBox.TrackWastedTime.Editor
{
    ...
    public static class TimeWasterHistory
    {
        ...
        public static RecompileDetector.RecompileCause LastRecompileCauseType { get; set; }
        public static string LastDomainReloadCause { get; set; }
        public static RecompileDetector.DomainReloadCause LastDomainReloadCauseType { get; set; }
        ...
        static TimeWasterHistory()
        {
            ...
            LastRecompileCauseType = (RecompileDetector.RecompileCause)EditorPrefs.GetInt("TW_LastRecompileCauseType", (int)RecompileDetector.RecompileCause.Unknown);

            LastDomainReloadCause = EditorPrefs.GetString("TW_LastDomainReloadCause", "First initialization");
            LastDomainReloadCauseType = (RecompileDetector.DomainReloadCause)EditorPrefs.GetInt("TW_LastDomainReloadCauseType", (int)RecompileDetector.DomainReloadCause.Unknown);
        }
        ...
        public static void AddRecompileCause(string cause, RecompileDetector.RecompileCause type)
        {
        ...
        public static void AddDomainReloadCause(string cause, RecompileDetector.DomainReloadCause type)
        {
